...
public class LdapAuthenticationFailureHandler extends ExceptionMappingAuthenticationFailureHandler {
	...
	public LdapAuthenticationFailureHandler(String defaultFailureUrl) {
		this.setDefaultFailureUrl(defaultFailureUrl);
	}
	
	public LdapAuthenticationFailureHandler(List<AuthenticationListener> authenticationListeners, String defaultFailureUrl) {
